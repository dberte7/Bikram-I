...
// a) crear las variables b)-hacer el bucle con i c)- dentro del bucle crear una variable con lo que quiere que se haga
for(let i= 0; i < 11;i++){
    postI = postI + postJ++
    console.log(postI);
...
let contarHasta10 = 0;
let i = 0;
while(i <= 9){//mientras la condición sea verdadera
    i++
    contarHasta10 = i
...
let sumaImpares = 0;
for(let i = 0; i < 10; i++){   //definición del bucle
    if( i % 2 != 0);          //Condicional para que me sume los numeros impares = divisiones que sean
